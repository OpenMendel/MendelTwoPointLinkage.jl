...
[![](https://img.shields.io/badge/docs-latest-blue.svg)](https://OpenMendel.github.io/MendelTwoPointLinkage.jl/latest)
...
To run this analysis package you will need to prepare a Control file and have your data files available. The Control file holds the names of your data files and any optional parameters for the analysis. Details on the general format and contents of the Control and data files can be found on the OpenMendel [documentation page](https://openmendel.github.io/). Descriptions of the specific options available within the MendelTwoPointLinkage analysis package are in its [documentation page](https://openmendel.github.io/MendelTwoPointLinkage.jl).

There are example data files in the "docs" subfolder of the MendelTwoPointLinkage package, for example, ~/.julia/v0.4/MendelTwoPointLinkage/docs.
